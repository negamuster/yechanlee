...
const sections = [
  ...
  },
  {
    title: 'Policy Tools',
    subtitle: '통화정책 수단',
    desc: '중앙은행은 정책금리를 실제 시장에 전달하기 위해 다양한 수단을 활용합니다. 공개시장조작은 국채 매입·매도를 통해 시중 유동성을 직접 조절하는 핵심 수단이며, 재할인율 정책은 은행이 중앙은행으로부터 자금을 빌릴 때 적용되는 금리로 금융 시스템의 안전판 역할을 합니다. 특히 양적완화(QE)는 중앙은행이 국채·MBS 등 자산을 대규모로 매입해 시중에 유동성을 직접 공급하는 수단으로, 금리가 이미 0에 근접했을 때 활용됩니다. 반대로 양적긴축(QT)은 보유 자산을 축소해 시중 유동성을 흡수하는 과정으로, 현대 통화정책에서 금리 조정과 함께 가장 중요한 정책 수단 중 하나입니다. 이러한 도구들은 함께 작동하며 금리 수준과 자금 흐름을 시장 전반에 전달합니다.',
    links: [],
    linkDesc: null,
    link: null,
  },
