  ...
  return (
    <div style={{ backgroundColor: '#ffffff', minHeight: '100vh', fontFamily: '"Times New Roman", Times, serif', color: '#000000' }}>
      <nav style={{ padding: '32px 48px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #e8e8e8' }}>
        ...
        <span style={{ fontSize: '13px', color: '#aaa' }}>02 — Interest Rates & Fed</span>
      </nav>
      <section style={{ maxWidth: '720px', margin: '0 auto', padding: '80px 48px 160px' }}>
        <p style={{ fontSize: '12px', letterSpacing: '0.15em', textTransform: 'uppercase', color: '#aaa', marginBottom: '24px' }}>02 / Interest Rates & Fed</p>
        <h1 style={{ fontSize: '48px', fontWeight: '400', letterSpacing: '-0.02em', marginBottom: '48px', lineHeight: '1.1' }}>Interest Rates & Fed</h1>
