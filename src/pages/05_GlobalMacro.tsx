      ...
      <div style={{ backgroundColor: '#ffffff', minHeight: '100vh', fontFamily: '"Times New Roman", Times, serif', color: '#000000' }}>
        ...
        <section className="page-section" style={{ maxWidth: '860px', margin: '0 auto', padding: '0 48px 160px' }}>
          <div style={{ borderTop: '1px solid #e8e8e8', paddingTop: '64px' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: '48px', padding: '56px 0', borderBottom: '1px solid #e8e8e8', alignItems: 'start' }}>
              <div>
                <p style={{ fontSize: '13px', letterSpacing: '0.1em', textTransform: 'uppercase', color: '#aaa', marginBottom: '12px' }}>Section Label</p>
                <h2 style={{ fontSize: '36px', fontWeight: '400', letterSpacing: '-0.01em', lineHeight: '1.1', color: '#000' }}>Section Title</h2>
              </div>
              <div>
                <p style={{ fontSize: '16px', lineHeight: '1.85', color: '#444', textAlign: 'justify', wordBreak: 'keep-all' }}>내용을 여기에 추가하세요.</p>
              </div>
            </div>
          </div>
        </section>
