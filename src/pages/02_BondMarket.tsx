...
const sections = [
  {
    ...
    link: { url: 'https://fred.stlouisfed.org/series/DGS10', label: 'FRED — 10Y Treasury Yield에서 보기 ↗' },
  },
  {
    title: 'Yield Curve',
    subtitle: '수익률 곡선',
    desc: '수익률 곡선은 만기가 다른 국채 금리를 연결한 곡선으로, 시장이 예상하는 금리 구조와 경기 방향을 보여주는 대표적인 선행지표입니다. 일반적으로는 장기 금리가 단기 금리보다 높은 우상향 형태를 보이지만, 단기 금리가 장기 금리를 초과하는 역전 상태는 경기 둔화 또는 침체 가능성을 시사하는 신호로 해석됩니다. 수익률 곡선을 볼 때는 단순한 금리 수준보다 곡선의 기울기 변화에 집중하는 것이 중요합니다. 곡선이 가팔라지면 경기 회복 기대가 반영된 것으로, 평탄화되면 성장 둔화 우려가 커지는 것으로, 역전되면 침체 가능성을 시장이 선반영하고 있는 것으로 해석할 수 있습니다.',
    link: { url: 'https://www.ustreasuryyieldcurve.com/', label: 'US Treasury Yield Curve에서 보기 ↗' },
  },
  {
    ...
    link: { url: 'https://fred.stlouisfed.org/series/BAMLH0A0HYM2', label: 'FRED — High Yield Spread에서 보기 ↗' },
  },
  {
    ...
    link: { url: 'https://fred.stlouisfed.org/series/DFII10', label: 'FRED — 10Y TIPS에서 보기 ↗' },
  },
]
