...
const sections = [
  ...
  },
  {
    ...
    subtitle: '신용 스프레드',
    desc: '신용 스프레드는 회사채 금리와 국채 금리의 차이로, 시장이 인식하는 신용 위험과 투자 심리를 반영합니다. 일반적으로 경기 상황이 안정적일 때는 스프레드가 축소되며, 불확실성이 커질수록 투자자들이 안전자산을 선호하면서 스프레드가 확대됩니다. 투자등급(Investment Grade) 스프레드와 고수익(High Yield) 스프레드를 함께 보면 리스크 온/오프 환경을 더 입체적으로 파악할 수 있습니다. 스프레드가 빠르게 확대되고 있다면 시장이 위험을 회피하고 있다는 신호로, 점진적으로 축소되고 있다면 위험 선호 환경으로 전환되고 있음을 의미합니다.',
    links: [
